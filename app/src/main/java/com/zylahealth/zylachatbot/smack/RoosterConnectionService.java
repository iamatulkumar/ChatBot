...
public class RoosterConnectionService extends Service {
    ...
    public static final String BUNDLE_MESSAGE_BODY = "atul@chat.service.zyla.in";
    public static final String BUNDLE_TO = "testzyla2@chat.poc.zyla.in";

    public static final String NEW_MESSAGE = "com.blikoon.rooster.newmessage";
    public static final String BUNDLE_FROM_JID = "atul@chat.poc.zyla.in";
